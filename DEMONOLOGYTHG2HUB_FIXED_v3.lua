            ...
            if item:IsA("Model") and item.PrimaryPart then
                ...
                if not isHeld then
                    ...
                    local offset = Vector3.new(
                        math.random(-2, 2),
                        1.5,  -- Chỉ nâng 1.5 studs để item gần sàn
                        math.random(-2, 2)
                    )
                    local targetPos = myPos + offset
                    
                    -- Raycast check để tránh stuck vào terrain
                    ...
                    count = count + 1
                    task.wait(0.2) -- Long delay để server sync + item settle
                end
            end
        end
