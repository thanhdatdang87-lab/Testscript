...
if (GameState == "MainGame") then
    ...
    -- ===== HUNT PATTERN AI V4 - REAL VERIFICATION LAYERS =====
    local huntHistory = {}
    local HuntDataLabel = CreateLog("Hunt Data: 0 hunts", UI["GhostTabInfo2"], 1, 170, false, nil, false, false)
    local HuntPatternLabel = CreateLog("Pattern: Analyzing", UI["GhostTabInfo2"], 1.3, 170, false, nil, false, false)
    local HuntPredictionLabel = CreateLog("Next Hunt: --:--", UI["GhostTabInfo2"], 1.6, 170, false, nil, false, false)
    local HuntAccuracyLabel = CreateLog("Confidence: 0%", UI["GhostTabInfo2"], 1.9, 170, false, nil, false, false)
    ...
    local function PredictNextHuntPerHunt()
        if #huntHistory < 2 then return nil end
    ...
    local function UpdateHuntAI()
        ...
        HuntDataLabel['Text'] = "Hunt Data: " .. huntCount .. " hunts recorded"
        if huntCount < 2 then
            HuntDataLabel['TextColor3'] = Color3.fromRGB(255, 0, 0)
        elseif huntCount < 5 then
            HuntDataLabel['TextColor3'] = Color3.fromRGB(255, 200, 0)
        else
            HuntDataLabel['TextColor3'] = Color3.fromRGB(0, 255, 0)
        end
