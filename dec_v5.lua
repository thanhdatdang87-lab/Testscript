        ...
        if autoSpiritActive then
            task.spawn(function()
                while autoSpiritActive do
                    ...
                    task.wait(1) -- Delay giữa các lần hỏi
                end
