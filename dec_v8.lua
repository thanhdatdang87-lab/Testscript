        ...
        while true do
            ...
            if (PlayerGui and PlayerGui:FindFirstChild("Subtitles")) then
                ...
                if child_6 then
                    ...
                    -- Danh sách keywords - nếu subtitle chứa bất kỳ keyword nào thì đó là Spirit Box response
                    local spiritBoxKeywords = {
                        "OLD", "I'M BEHIND YOU", "DEATH", "KILL", "ATTACK", "HATE",
                        "HELP", "LEAVE", "GET OUT", "RUN", "AFRAID", "ANGRY",
                        "YES", "NO", "HERE", "STAY", "INSIDE", "OUTSIDE",
                        "COMING", "FOUND", "WATCH", "LISTEN", "WAIT", "GO",
                        "UP", "DOWN", "COLD", "HOT", "PAIN", "HURT"
                    }
