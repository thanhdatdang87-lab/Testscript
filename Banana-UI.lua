...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,206,27") .. ")\">" .. tostring(getgenv().TitleNameNoti or "") .. "</font>"
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Title or ""
    ...
    if Setting.Color then
        local colorPresets = {
            ...
            ["Yellow"] = Color3.fromRGB(255, 206, 27),
        }
        local accent = colorPresets[Setting.Color]
        if accent then
            local darker = Color3.fromRGB(
                math.floor(accent.R * 200),
                math.floor(accent.G * 200),
                math.floor(accent.B * 200)
            )
            getgenv().UIColor["Border Color"]               = accent
            getgenv().UIColor["Title Text Color"]           = accent
            getgenv().UIColor["Page Selected Color"]        = accent
            getgenv().UIColor["Section Underline Color"]    = accent
            getgenv().UIColor["Toggle Border Color"]        = accent
            getgenv().UIColor["Toggle Checked Color"]       = accent
            getgenv().UIColor["Button Color"]               = accent
            getgenv().UIColor["Dropdown Selected Color"]    = accent
            getgenv().UIColor["Dropdown Selected Check Color"] = darker
            getgenv().UIColor["Textbox Highlight Color"]    = accent
            getgenv().UIColor["Box Highlight Color"]        = accent
            getgenv().UIColor["Slider Line Color"]          = accent
            getgenv().UIColor["Slider Highlight Color"]     = darker
            getgenv().UIColor["Search Icon Highlight Color"] = accent
        end
    end
	...
	local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
    TextLabelMain.Text = "<font color=\"rgb(" .. tostring(color or "255,206,27") .. ")\">" .. tostring(TitleNameMain) .. "</font> " .. tostring(getgenv().MainDesc or "")
