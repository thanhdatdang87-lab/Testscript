...
if (GameState == "MainGame") then
    ...
    local function UpdateEvidenceSuggester()
        ...
        if evidenceCount < 2 then
            -- Chưa đủ 2 evidence
            EvidenceLabel['Text'] = "Need 2 evidence to suggest the 3 evidence for you."
        ...
        elseif evidenceCount == 2 then
            ...
            -- Tìm những loại ma có chứa CHÍNH XÁC 2 evidence hiện tại
            ...
            for ghostName, ghostEvs in pairs(ghostTypes) do
                ...
                for _, ghostEv in ipairs(ghostEvs) do
                    ...
                    if not found then
                        thirdEvidence = ghostEv  -- Lấy evidence không match (evidence thứ 3)
                    end
                end
            ...
            if #thirdEvidenceSet > 0 then
                local suggestionText = table.concat(thirdEvidenceSet, " or ")
