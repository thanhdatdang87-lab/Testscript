...
local function CreateKeybind(input_13, input_14)
    ...
    frame_7['Size'] = UDim2.new(0, 400, 0, 100)
    frame_7['BackgroundTransparency'] = 0
    frame_7['Position'] = UDim2.new(0, -450, 0.05, 0)
    ...
    local pos = TweenService:Create(frame_7, tweenInfo_6, {["Position"]=UDim2.new(0, 20, 0.05, frame_7['Position']['Y'].Offset)})
    pos:Play()
    pos['Completed']:Wait()
    local tweenInfo_7 = TweenInfo.new(0.15, Enum['EasingStyle'].Back, Enum['EasingDirection'].Out)
    local pos_2 = TweenService:Create(frame_7, tweenInfo_7, {["Position"]=UDim2.new(0, 10, 0.05, frame_7['Position']['Y'].Offset)})
    pos_2:Play()
    pos_2['Completed']:Wait()
    task.wait(input_14)
    local tweenInfo_8 = TweenInfo.new(0.35, Enum['EasingStyle'].Back, Enum['EasingDirection'].In)
    local pos_3 = TweenService:Create(frame_7, tweenInfo_8, {["Position"]=UDim2.new(0, -450, 0.05, frame_7['Position']['Y'].Offset)})
    pos_3:Play()
